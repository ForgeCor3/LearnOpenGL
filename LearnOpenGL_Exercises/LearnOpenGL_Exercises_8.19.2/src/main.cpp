...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(width, height, "LearnOpenGL_Exercises", NULL, NULL);
    if(window == nullptr)
    {
    ...
    while(!glfwWindowShouldClose(window))
    {
        ...
        trans = glm::mat4(1.0f);
        trans = glm::translate(trans, glm::vec3(-0.5f, 0.5f, 0.0f));
        trans = glm::scale(trans, glm::vec3(glm::sin(glfwGetTime()), glm::sin(glfwGetTime()), 0.0));
        glUniformMatrix4fv(glGetUniformLocation(shaderProgram, "transform"), 1, GL_FALSE, glm::value_ptr(trans));
